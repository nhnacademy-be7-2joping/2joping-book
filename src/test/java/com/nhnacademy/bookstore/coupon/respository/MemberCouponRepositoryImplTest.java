...
class MemberCouponRepositoryImplTest {
    ...
    void testGetAllMemberOrderCoupons() {
        ...
        assertEquals("Test Coupon", orderCoupons.get(0).name());
        assertEquals("Policy Detail", orderCoupons.get(0).detail());
        assertEquals(10, orderCoupons.get(0).discountValue());
        assertEquals(50, orderCoupons.get(0).maxDiscount());
        assertEquals(DiscountType.ACTUAL, orderCoupons.get(0).discountType());
    }
}
