...
class PointTypeControllerTest {
    ...
    void getAllActivePointTypes() throws Exception {
        ReadPointTypeResponseDto activeResponseDto1 = new ReadPointTypeResponseDto(1L, PointTypeEnum.ACTUAL, 10, "리뷰 포인트1", true);
        ReadPointTypeResponseDto activeResponseDto2 = new ReadPointTypeResponseDto(2L, PointTypeEnum.PERCENT, 15, "리뷰 포인트2", true);
